  ...
  switch(properties.type) {
    ...
    case 'object':
      ...
      if(properties.objectType) {
        // The object will usually exist because it's initialized immediately for deep access
        ...
        if(!_.isUndefined(originalValue)) {
          ...
          // The value didn't already exist so we didn't copy it over
          // Instead, we're going to clone it to the SchemaObject
          var schemaObject = new SchemaObject(properties.type);
          return value;
        }
      }
  ...
  return function(defaults) {
    ...
    this.toObject = function() {
      ...
      _.each(schema, function(properties, index) {
        ...
        || properties.type !== 'object' && properties.type !== 'date') {
          getObj[index] = value;
